...
const ITTraining = () => {
    ...
    return (
        <div style={{ fontFamily: "Montserrat, sans-serif" }}>
            <Navbar />
            <Heading style={{ textAlign: "left", padding: "30px 40px" }}
            fontSize={{ base: "3xl", md: "3xl", lg: "4xl" }}>IT Training</Heading>
            <Flex bg="gray.100" style={{ padding: "60px 40px"}} flexDirection={ isLarge ? "row" : "column" } minH={"100vh"}>
                ...
                >
                    {
                        itData.map((program) => (
                            <Link key={program.id} to={`/programs/${program.id}`}>
                                <GridItem 
                                h={{ base: "340px", md: "340px", lg: "310px" }}
