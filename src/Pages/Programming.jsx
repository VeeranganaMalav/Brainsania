import { Box, Grid, GridItem, HStack, Heading, Input, Radio, RadioGroup, Select, Stack, Text, VStack } from '@chakra-ui/react'
                    ...
                    <Box w="100%" style={{ borderRadius: "25px", background: "white", padding: "20px 20px" }}>
                        ...
                        <RadioGroup>
                            <Stack spacing={5} direction='column'>
                                ...
                                <Radio colorScheme='blue' value='product management'>
                                    Product Management
                                </Radio>
